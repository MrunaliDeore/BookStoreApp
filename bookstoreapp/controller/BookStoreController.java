...
public class BookStoreController {
    ...
    public ResponseEntity<ResponseDTO> sortByAsc (@Valid @PathVariable String feild){
        ResponseDTO responseDTO = new ResponseDTO("Get data in ascending order :", bookStoreService.sortByAsc(feild));
        return new ResponseEntity<>(responseDTO, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseDTO> sortByDesc (@Valid @PathVariable String feild){
        ResponseDTO responseDTO = new ResponseDTO("Get data in descending order :", bookStoreService.sortByDesc(feild));
        return new ResponseEntity<>(responseDTO, HttpStatus.OK);
    }
